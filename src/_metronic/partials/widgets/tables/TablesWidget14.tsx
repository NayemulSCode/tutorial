    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Nails</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Over 23 services</span>
        </h3>
          ...
          >
            ...
            <div className='menu-item px-3'>
              <div className='menu-content px-3 py-3'>
                <a className='btn btn-danger btn-sm px-4' href='#'>
                  Delete Category
                </a>
              </div>
            </div>
