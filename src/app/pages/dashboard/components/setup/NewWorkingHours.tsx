...
// monday time set
  ...
  const handleSubmit=()=>{
    ...
    updateBusinessWorkingHour({
        variables: {
            daily_work_hours: JSON.stringify(modifyObj)
        }
    }).then(({ data }) => {
  ...
  return (
    ...
    <div className="mb-0 fv-row">
      ...
      {/* <button onClick={handleSubmit} type='submit' className='btn btn-lg btn-primary steper-next-btn'>
        ...
        <Button className="btn btn-primary mt-4 text-gray-400 fw-bold fs-6" style={{ marginLeft: "10px" }} onClick={handleSubmit} disabled={loading}>
