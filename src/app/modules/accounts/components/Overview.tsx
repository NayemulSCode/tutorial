        ...
        <div className='card-body p-9'>
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bolder fs-6 text-dark'>{`${accInfo?.first_name} ${accInfo?.last_name}`}</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8 fv-row'>
              <span className='fw-bold fs-6'>{accInfo?.business_info?.name}</span>
            </div>
          </div>
          
          <div className='row mb-7'>
            <label className='col-lg-4 fw-bold text-muted'>Company Size</label>

            <div className='col-lg-8 fv-row'>
              <span className='fw-bold fs-6'>{accInfo?.business_info?.team_size}</span>
            </div>
          </div>
          ...
          <div className='row mb-7'>
            ...
            <div className='col-lg-8 d-flex align-items-center'>
              <span className='fw-bolder fs-6 me-2'>{accInfo?.mobile}</span>
