            ...
            <div className='table-responsive'>
              <table className='table table-row-dashed border-gray-300 align-middle gy-6'>
                <tbody className='fs-6 fw-bold'>
                  ...
                  <tr>
                    <td>New appointments and marketplace sales</td>
                    <td>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td className='border-bottom-0'>No Shows</td>
                  ...
                  <tr>
                    <td className='border-bottom-0'>Confirmations</td>
                    <td className='border-bottom-0'>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td className='border-bottom-0'>Arrivals</td>
                    <td className='border-bottom-0'>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td className='border-bottom-0'>Started</td>
                    <td className='border-bottom-0'>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td className='border-bottom-0'>Tips</td>
                    <td className='border-bottom-0'>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
